...
function initializeGame(){
    ...
    //Posición y dirección inicial de la comida
    ...
    //Set dirección inicial de la serpiente
    dx = 0;
    dy = -GRID_SIZE;
    blinkCounter = 0;
    score =0;
...
//Generar una posición de la comida que no colisione con la serpiente
...
function generateFoodPosition(){
    while(true){
        ...
        //Regresar a la posición si no hay colisión
...
//Check for collisitions with wall or self
...
function update(){
    ...
    //Calculated new snake head position
    ...
    if(head.x === food.x && head.y === food.y){
        ...
        //Check for win condition (sanke fills entire screen)
...
//Draw game objects (sanke and food)
...
function draw(){
    ...
    for(const segment of snake ){
        ...
        context.fillRect(segment.x , segment.y,
